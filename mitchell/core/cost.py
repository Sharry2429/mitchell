...
MODEL_PRICING: Dict[str, Dict[str, float]] = {
    # Groq (free tier — cost tracked at $0 but usage limited)
    ...
    "meta/llama-3.1-70b-instruct": {"input": 0.00, "output": 0.00},
    # OpenRouter (free tier models)
    "meta-llama/llama-3.1-8b-instruct:free": {"input": 0.00, "output": 0.00},
    "qwen/qwen-2.5-72b-instruct:free": {"input": 0.00, "output": 0.00},
    # Grok (xAI)
